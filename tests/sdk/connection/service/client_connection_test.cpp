...
HWTEST_F(ClientConnectionTest, ClientConnectionTest, TestSize.Level0)
{
    ...
    ASSERT_EQ(ret, SOFTBUS_OK);
    ret = GeneraConnGetPeerDeviceId(0, nullptr, 0);
    ASSERT_EQ(ret, SOFTBUS_INVALID_PARAM);
    ...
    char udid[len] = { 0 };
    ret = GeneraConnGetPeerDeviceId(1, udid, invalidLen);
    ASSERT_EQ(ret, SOFTBUS_INVALID_PARAM);
    ret = GeneraConnGetPeerDeviceId(1, udid, 0);
    ASSERT_EQ(ret, SOFTBUS_INVALID_PARAM);
    ret = GeneraConnGetPeerDeviceId(1, udid, len);
    ASSERT_EQ(ret, SOFTBUS_OK);
    ret = GeneralUnregisterListener();
    ASSERT_EQ(ret, SOFTBUS_OK);
}
