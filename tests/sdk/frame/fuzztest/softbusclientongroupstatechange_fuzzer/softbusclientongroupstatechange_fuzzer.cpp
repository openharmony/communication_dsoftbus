...
#include "softbusclientongroupstatechange_fuzzer.h"
...
bool OnGroupStateChangeInnerTest(FuzzedDataProvider &provider)
{
    ...
    softBusClientStub->OnRemoteRequest(CLIENT_ON_GROUP_STATE_CHANGE, datas, reply, option);
...
extern "C" int32_t LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::OnGroupStateChangeInnerTest(provider);
    return 0;
}
