...
bool OnTransmitAuthResultInnerTest(FuzzedDataProvider &provider)
{
    ...
    softBusClientStub->OnRemoteRequest(CLIENT_ON_TRANSMIT_AUTH_RESULT, datas, reply, option);
    return true;
}
} // namespace OHOS
...
extern "C" int32_t LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::OnTransmitAuthResultInnerTest(provider);
    return 0;
}