...
bool OnFinishAuthResultInnerTest(const uint8_t *data, size_t size)
{
    ...
    softBusClientStub->OnRemoteRequest(CLIENT_ON_FINISH_AUTH_RESULT, datas, reply, option);
    return true;
}
} // namespace OHOS
...
extern "C" int32_t LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::OnFinishAuthResultInnerTest(data, size);
    return 0;
}