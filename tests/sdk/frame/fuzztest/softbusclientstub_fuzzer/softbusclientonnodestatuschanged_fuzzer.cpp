...
bool OnNodeStatusChangedInnerTest(FuzzedDataProvider &provider)
{
    ...
    softBusClientStub->OnRemoteRequest(CLIENT_ON_NODE_STATUS_CHANGED, datas, reply, option);
    return true;
}
} // namespace OHOS
...
extern "C" int32_t LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::OnNodeStatusChangedInnerTest(provider);
    return 0;
}
