...
{
    /*
     * 1. Device A calls CreateSessionServer() to create a session server based on the application bundle name and session name,
     * and registers the callbacks for session opened, session closed, byte received, and message received.
     */
