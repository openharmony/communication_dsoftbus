...
public:
    ...
    virtual uint32_t SoftBusHtoL1(uint32_t value) = 0;
    virtual uint32_t SoftBusHtoN1(uint32_t value) = 0;
    ...
    virtual uint8_t *TransProxyPackData(ProxyDataInfo *dataInfo, uint32_t sliceNum,
        SessionPktType pktType, uint32_t cnt, uint32_t *dataLen) = 0;
...
public:
    ...
    MOCK_METHOD1(SoftBusHtoL1, uint32_t (uint32_t value));
    MOCK_METHOD1(SoftBusHtoN1, uint32_t (uint32_t value));
    ...
    MOCK_METHOD5(TransProxyPackData, uint8_t* (ProxyDataInfo *dataInfo, uint32_t sliceNum,
