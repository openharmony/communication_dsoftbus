...
MATCHER_P2(LnnValidParamArrayMatcher, inExtra, validSize, "lnn valid param array match fail")
{
    ...
    MatchLnnEventNameTypeExtraUint64Param(params, ++index, extra.laneId);
    ...
    MatchLnnEventNameTypeExtraUint32Param(params, ++index, extra.laneLinkType);
    ...
    MatchLnnEventNameTypeExtraUint32Param(params, ++index, extra.minBW);
    MatchLnnEventNameTypeExtraUint32Param(params, ++index, extra.maxLaneLatency);
    MatchLnnEventNameTypeExtraUint32Param(params, ++index, extra.minLaneLatency);
    ...
    MatchLnnEventNameTypeExtraUint32Param(params, ++index, extra.localDynamicCap);
    MatchLnnEventNameTypeExtraUint32Param(params, ++index, extra.remoteDynamicCap);
