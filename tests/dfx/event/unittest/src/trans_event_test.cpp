...
HWTEST_F(TransEventTest, TransEventTest001, TestSize.Level0)
{
    ...
    constexpr int32_t VALID_EXTRA_SIZE = 22;  //result errcode socketName firstTokenId
...
HWTEST_F(TransEventTest, TransEventTest003, TestSize.Level0)
{
    ...
    constexpr int32_t VALID_EXTRA_SIZE = 20; // result, errcode , firstTokenId and each ui8 is valid

    HiSysEventMock mock;
    EXPECT_CALL(mock,
        HiSysEvent_Write(_, _, StrEq(SOFTBUS_EVENT_DOMAIN), StrEq(TRANS_EVENT_NAME), Eq(SOFTBUS_EVENT_TYPE_BEHAVIOR),
            TransInvalidParamArrayMatcher(invalidExtra, VALID_EXTRA_SIZE), ParamArraySizeMatcher(VALID_EXTRA_SIZE + 1)))
        .Times(1);
...
HWTEST_F(TransEventTest, TransEventTest004, TestSize.Level0)
{
    ...
    EXPECT_CALL(mock,
        HiSysEvent_Write(_, _, StrEq(SOFTBUS_EVENT_DOMAIN), StrEq(TRANS_EVENT_NAME), Eq(SOFTBUS_EVENT_TYPE_BEHAVIOR),
            TransInvalidParamArrayMatcher(emptyExtra, VALID_EXTRA_SIZE), ParamArraySizeMatcher(VALID_EXTRA_SIZE + 1)))
        .Times(1);
...
HWTEST_F(TransEventTest, TransEventTest007, TestSize.Level0)
{
    ...
    constexpr int32_t VALID_EXTRA_SIZE = 37;
    HiSysEventMock mock;
    EXPECT_CALL(mock,
        HiSysEvent_Write(_, _, StrEq(SOFTBUS_EVENT_DOMAIN), StrEq(TRANS_EVENT_NAME), Eq(SOFTBUS_EVENT_TYPE_BEHAVIOR), _,
            ParamArraySizeMatcher(VALID_EXTRA_SIZE)))
    ...
    constexpr int32_t VALID_EXTRA_SIZE1 = 27;
    ...
    constexpr int32_t VALID_EXTRA_SIZE2 = 25;
    ...
    constexpr int32_t VALID_EXTRA_SIZE3 = 24;
