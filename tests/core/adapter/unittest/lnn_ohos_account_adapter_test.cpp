...
/*
 * @tc.name: LnnIsOsAccountConstraint_Default_001
 * @tc.desc: Verify LnnIsOsAccountConstraint returns false by default
 * @tc.type: FUNC
 * @tc.require: 1
 */
HWTEST_F(LnnOhosAccountAdapterTest, LnnIsOsAccountConstraint_Default_001, TestSize.Level1)
{
    EXPECT_NO_FATAL_FAILURE(LnnDeinitOsAccountAdapter());
    EXPECT_EQ(LnnIsOsAccountConstraint(), false);
}

/*
 * @tc.name: LnnDeinitOsAccountAdapter_MultipleDeinit_001
 * @tc.desc: Verify LnnDeinitOsAccountAdapter is safe to call multiple times
 * @tc.type: FUNC
 * @tc.require: 1
 */
HWTEST_F(LnnOhosAccountAdapterTest, LnnDeinitOsAccountAdapter_MultipleDeinit_001, TestSize.Level1)
{
    EXPECT_NO_FATAL_FAILURE(LnnDeinitOsAccountAdapter());
    EXPECT_NO_FATAL_FAILURE(LnnDeinitOsAccountAdapter());
    EXPECT_EQ(LnnIsOsAccountConstraint(), false);
...
/*
 * @tc.name: LnnDeinitOsAccountAdapter_ResetState_001
 * @tc.desc: Verify LnnDeinitOsAccountAdapter resets constraint state to false
 * @tc.type: FUNC
 * @tc.require: 1
 */
HWTEST_F(LnnOhosAccountAdapterTest, LnnDeinitOsAccountAdapter_ResetState_001, TestSize.Level1)
{
    EXPECT_NO_FATAL_FAILURE(LnnDeinitOsAccountAdapter());
    EXPECT_EQ(LnnIsOsAccountConstraint(), false);
}
...
/*
 * @tc.name: LnnDeinitOsAccountAdapter_MultipleDeinit_002
 * @tc.desc: Verify LnnDeinitOsAccountAdapter is safe to call after multiple inits
 * @tc.type: FUNC
 * @tc.require: 1
 */
HWTEST_F(LnnOhosAccountAdapterTest, LnnDeinitOsAccountAdapter_MultipleDeinit_002, TestSize.Level1)
{
    EXPECT_NO_FATAL_FAILURE(LnnDeinitOsAccountAdapter());
    EXPECT_NO_FATAL_FAILURE(LnnInitOsAccountAdapter());
    EXPECT_NO_FATAL_FAILURE(LnnDeinitOsAccountAdapter());
    EXPECT_EQ(LnnIsOsAccountConstraint(), false);
}

/*
 * @tc.name: LnnIsOsAccountConstraint_AfterDeinit_001
 * @tc.desc: Verify LnnIsOsAccountConstraint returns false after deinit
 * @tc.type: FUNC
 * @tc.require: 1
 */
HWTEST_F(LnnOhosAccountAdapterTest, LnnIsOsAccountConstraint_AfterDeinit_001, TestSize.Level1)
{
    EXPECT_NO_FATAL_FAILURE(LnnDeinitOsAccountAdapter());
    EXPECT_EQ(LnnIsOsAccountConstraint(), false);
}
...
/*
 * @tc.name: LnnDeinitOsAccountAdapter_InitDeinitCycle_001
 * @tc.desc: Verify multiple deinit cycles are stable
 * @tc.type: FUNC
 * @tc.require: 1
 */
HWTEST_F(LnnOhosAccountAdapterTest, LnnDeinitOsAccountAdapter_InitDeinitCycle_001, TestSize.Level1)
{
    for (int i = 0; i < 3; i++) {
        EXPECT_NO_FATAL_FAILURE(LnnDeinitOsAccountAdapter());
    }
...
/*
 * @tc.name: LnnDeinitOsAccountAdapter_ClearsAllStates_001
 * @tc.desc: Verify LnnDeinitOsAccountAdapter clears all constraint states
 * @tc.type: FUNC
 * @tc.require: 1
 */
HWTEST_F(LnnOhosAccountAdapterTest, LnnDeinitOsAccountAdapter_ClearsAllStates_001, TestSize.Level1)
{
    EXPECT_NO_FATAL_FAILURE(LnnDeinitOsAccountAdapter());
    EXPECT_EQ(LnnIsOsAccountConstraint(), false);
}
...
/*
 * @tc.name: LnnClearOsAccountAdapterStatus_001
 * @tc.desc: Verify LnnClearOsAccountAdapterStatus executes without fatal errors
 * @tc.type: FUNC
 * @tc.require: 1
 */
HWTEST_F(LnnOhosAccountAdapterTest, LnnClearOsAccountAdapterStatus_001, TestSize.Level1)
{
    EXPECT_NO_FATAL_FAILURE(LnnClearOsAccountAdapterStatus());
}

/*
 * @tc.name: LnnClearOsAccountAdapterStatus_002
 * @tc.desc: Verify LnnClearOsAccountAdapterStatus resets constraint state to false
 * @tc.type: FUNC
 * @tc.require: 1
 */
HWTEST_F(LnnOhosAccountAdapterTest, LnnClearOsAccountAdapterStatus_002, TestSize.Level1)
{
    EXPECT_NO_FATAL_FAILURE(LnnClearOsAccountAdapterStatus());
    EXPECT_EQ(LnnIsOsAccountConstraint(), false);
}
...
/*
 * @tc.name: LnnClearOsAccountAdapterStatus_003
 * @tc.desc: Verify LnnClearOsAccountAdapterStatus is safe to call multiple times
 * @tc.type: FUNC
 * @tc.require: 1
 */
HWTEST_F(LnnOhosAccountAdapterTest, LnnClearOsAccountAdapterStatus_003, TestSize.Level1)
{
    EXPECT_NO_FATAL_FAILURE(LnnClearOsAccountAdapterStatus());
    EXPECT_NO_FATAL_FAILURE(LnnClearOsAccountAdapterStatus());
    EXPECT_NO_FATAL_FAILURE(LnnClearOsAccountAdapterStatus());
