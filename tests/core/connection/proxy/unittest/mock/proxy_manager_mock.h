...
public:
    ...
    virtual bool IsPairedDevice(const char *addr, bool isRealMac, bool *isSupportHfp, bool *isAclConnected) = 0;
...
public:
    ...
    MOCK_METHOD(bool, IsPairedDevice, (const char *addr,  bool isRealMac, bool *isSupportHfp,
        bool *isAclConnected), (override));
    ...
    static bool ActionOfIsPairedDevice(const char *addr, bool isRealMac, bool *isSupportHfp, bool *isAclConnected);
