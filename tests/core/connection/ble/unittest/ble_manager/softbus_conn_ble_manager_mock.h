...
#ifndef SOFTBUS_CONN_BLE_MANAGER_MOCK_H
#define SOFTBUS_CONN_BLE_MANAGER_MOCK_H
...
class BleManagerTestMockInterface {
public:
    BleManagerTestMockInterface() = default;
    virtual ~BleManagerTestMockInterface() = default;
    ...
    virtual int32_t SoftBusGattsAddDescriptor(int32_t srvcHandle, SoftBusBtUuid Uuid, int32_t permissions) = 0;
    ...
    virtual int32_t BleHiDumperRegister() = 0;
};

class BleManagerTestMock : public BleManagerTestMockInterface {
public:
    static BleManagerTestMock *GetMock()
    {
        return mock.load();
    }

    BleManagerTestMock();
    ~BleManagerTestMock() override;
    ...
    MOCK_METHOD(int32_t, LnnRegisterEventHandler, (LnnEventType, LnnEventHandler), (override));
    MOCK_METHOD(int64_t, ConnBlePackCtlMessage,
        (BleCtlMessageSerializationContext, uint8_t **, uint32_t *), (override));
    ...
    MOCK_METHOD(int32_t, SoftBusGattsAddDescriptor, (int32_t, SoftBusBtUuid, int32_t), (override));
    MOCK_METHOD(int32_t, SoftBusGattsAddCharacteristic, (int32_t, SoftBusBtUuid, int32_t, int32_t), (override));
    MOCK_METHOD(int32_t, SoftBusGattsStartService, (int32_t), (override));
    MOCK_METHOD(int32_t, SoftBusGattsSendResponse, (SoftBusGattsResponse *), (override));
    MOCK_METHOD(ConnBleConnection *,
        LegacyBleCreateConnection, (const char *, ConnSideType, int32_t, bool), (override));
    ...
    MOCK_METHOD(int32_t, ConnGattInitClientModule, (SoftBusLooper *, const ConnBleClientEventListener *), (override));
    MOCK_METHOD(int32_t, ConnGattInitServerModule, (SoftBusLooper *, const ConnBleServerEventListener *), (override));
    MOCK_METHOD(bool, GetJsonObjectSignedNumberItem,
        (const cJSON *json, const char * const str, int32_t *target), (override));
    MOCK_METHOD(bool,
        GetJsonObjectNumber16Item, (const cJSON *json, const char * const str, uint16_t *target), (override));
    MOCK_METHOD(int32_t, BleHiDumperRegister, (), (override));

private:
    static inline std::atomic<BleManagerTestMock *> mock = nullptr;
};
} // namespace OHOS::SoftBus

#endif // SOFTBUS_CONN_BLE_MANAGER_MOCK_H
