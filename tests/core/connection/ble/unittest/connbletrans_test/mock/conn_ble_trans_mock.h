...
#ifndef CONN_BLE_TRANS_MOCK_H
#define CONN_BLE_TRANS_MOCK_H
...
namespace OHOS {
class ConnBleTransInterface {
public:
    ConnBleTransInterface(){};
    virtual ~ConnBleTransInterface(){};
...
class ConnBleTransInterfaceMock : public ConnBleTransInterface {
public:
    ConnBleTransInterfaceMock();
    ~ConnBleTransInterfaceMock() override;
