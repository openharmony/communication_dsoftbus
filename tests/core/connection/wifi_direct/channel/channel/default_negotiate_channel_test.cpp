...
HWTEST_F(WifiDirectChannelTest, testDirectChannelTest002, TestSize.Level0)
{
    ...
    uint8_t arr[] = {0x01, 0x02, 0x03, 0x04, 0x05};
    const uint8_t *data = arr;
    size_t size = 10;
    int32_t ret = DefaultNegotiateChannelNew(1)->postData(&channel, data, size);
    EXPECT_EQ(SOFTBUS_ERR, ret);
};
...
/*
* @tc.name: testDirectChannelTest010
* @tc.desc: test Duplicate
* @tc.type: FUNC
* @tc.require: AR000I9Q40
*/
