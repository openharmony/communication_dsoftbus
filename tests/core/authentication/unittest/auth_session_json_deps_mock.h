...
public:
    ...
    virtual bool IsPotentialTrustedDeviceDp(const char *deviceIdHash, bool isPointToPoint) = 0;
    ...
    virtual bool JSON_GetBytesFromObject(
        const JsonObj *obj, const char *key, uint8_t *value, uint32_t bufLen, uint32_t *size) = 0;
