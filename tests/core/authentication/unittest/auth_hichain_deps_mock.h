...
public:
    ...
    virtual int32_t IdServiceAuthCredential(
        int32_t userId, int64_t authReqId, const char *authParams, const DeviceAuthCallback *cb) = 0;
    virtual int32_t IdServiceProcessCredData(
