 ...
 * @tc.desc: Invalid param, uuid is nullptr
 * @tc.type: FUNC
 * @tc.level: Level1
 * @tc.require:
 */
HWTEST_F(AuthManagerMockTest, IS_NEED_REOPEN_AUTH_CONNECTION_TEST_001, TestSize.Level1)
{
 ...
 * @tc.desc: LnnConvertDlId fail, return false
 * @tc.type: FUNC
 * @tc.level: Level1
 * @tc.require:
 */
HWTEST_F(AuthManagerMockTest, IS_NEED_REOPEN_AUTH_CONNECTION_TEST_002, TestSize.Level1)
{
    AuthManagerInterfaceMock authManagerMock;
    EXPECT_CALL(authManagerMock, LnnConvertDlId)
        .WillOnce(Return(SOFTBUS_INVALID_PARAM));
    bool ret = IsNeedReOpenAuthConnection(UUID_TEST);
    EXPECT_FALSE(ret);
}

/*
 * @tc.name: IS_NEED_REOPEN_AUTH_CONNECTION_TEST_003
 * @tc.desc: LnnGetRemoteNumU32Info fail, return false
 * @tc.type: FUNC
 * @tc.level: Level1
 * @tc.require:
 */
HWTEST_F(AuthManagerMockTest, IS_NEED_REOPEN_AUTH_CONNECTION_TEST_003, TestSize.Level1)
{
    AuthManagerInterfaceMock authManagerMock;
    EXPECT_CALL(authManagerMock, LnnConvertDlId)
        .WillRepeatedly(Return(SOFTBUS_OK));
...
/*
 * @tc.name: IS_NEED_REOPEN_AUTH_CONNECTION_TEST_004
 * @tc.desc: Value has neither ONLINE_METANODE nor ONLINE_HICHAIN, return false
 * @tc.type: FUNC
 * @tc.level: Level1
 * @tc.require:
 */
HWTEST_F(AuthManagerMockTest, IS_NEED_REOPEN_AUTH_CONNECTION_TEST_004, TestSize.Level1)
{
    AuthManagerInterfaceMock authManagerMock;
    EXPECT_CALL(authManagerMock, LnnConvertDlId)
        .WillRepeatedly(Return(SOFTBUS_OK));
...
/*
 * @tc.name: IS_NEED_REOPEN_AUTH_CONNECTION_TEST_005
 * @tc.desc: Value has only ONLINE_METANODE but not ONLINE_HICHAIN, return false
 * @tc.type: FUNC
 * @tc.level: Level1
 * @tc.require:
 */
HWTEST_F(AuthManagerMockTest, IS_NEED_REOPEN_AUTH_CONNECTION_TEST_005, TestSize.Level1)
{
    AuthManagerInterfaceMock authManagerMock;
    EXPECT_CALL(authManagerMock, LnnConvertDlId)
        .WillRepeatedly(Return(SOFTBUS_OK));
    uint32_t value = (1 << ONLINE_METANODE);
    EXPECT_CALL(authManagerMock, LnnGetRemoteNumU32Info)
        .WillOnce(DoAll(SetArgPointee<2>(value), Return(SOFTBUS_OK)));
    bool ret = IsNeedReOpenAuthConnection(UUID_TEST);
    EXPECT_FALSE(ret);
}

/*
 * @tc.name: IS_NEED_REOPEN_AUTH_CONNECTION_TEST_006
 * @tc.desc: Value has only ONLINE_HICHAIN but not ONLINE_METANODE, return false
 * @tc.type: FUNC
 * @tc.level: Level1
 * @tc.require:
 */
HWTEST_F(AuthManagerMockTest, IS_NEED_REOPEN_AUTH_CONNECTION_TEST_006, TestSize.Level1)
{
    AuthManagerInterfaceMock authManagerMock;
    EXPECT_CALL(authManagerMock, LnnConvertDlId)
        .WillRepeatedly(Return(SOFTBUS_OK));
    uint32_t value = (1 << ONLINE_HICHAIN);
    EXPECT_CALL(authManagerMock, LnnGetRemoteNumU32Info)
        .WillOnce(DoAll(SetArgPointee<2>(value), Return(SOFTBUS_OK)));
    bool ret = IsNeedReOpenAuthConnection(UUID_TEST);
    EXPECT_FALSE(ret);
...
/*
 * @tc.name: IS_NEED_REOPEN_AUTH_CONNECTION_TEST_007
 * @tc.desc: RequireAuthLock fail, return false
 * @tc.type: FUNC
 * @tc.level: Level1
 * @tc.require:
 */
HWTEST_F(AuthManagerMockTest, IS_NEED_REOPEN_AUTH_CONNECTION_TEST_007, TestSize.Level1)
{
    AuthManagerInterfaceMock authManagerMock;
    EXPECT_CALL(authManagerMock, LnnConvertDlId)
        .WillRepeatedly(Return(SOFTBUS_OK));
    uint32_t value = (1 << ONLINE_METANODE) | (1 << ONLINE_HICHAIN);
    EXPECT_CALL(authManagerMock, LnnGetRemoteNumU32Info)
        .WillOnce(DoAll(SetArgPointee<2>(value), Return(SOFTBUS_OK)));
    EXPECT_CALL(authManagerMock, RequireAuthLock)
        .WillOnce(Return(false));
...
/*
 * @tc.name: IS_NEED_REOPEN_AUTH_CONNECTION_TEST_008
 * @tc.desc: Both client and server not found, return true (need reopen)
 * @tc.type: FUNC
 * @tc.level: Level1
 * @tc.require:
 */
HWTEST_F(AuthManagerMockTest, IS_NEED_REOPEN_AUTH_CONNECTION_TEST_008, TestSize.Level1)
{
    AuthManagerInterfaceMock authManagerMock;
    EXPECT_CALL(authManagerMock, LnnConvertDlId)
        .WillRepeatedly(Return(SOFTBUS_OK));
...
/*
 * @tc.name: IS_NEED_REOPEN_AUTH_CONNECTION_TEST_009
 * @tc.desc: Client auth manager found, return false
 * @tc.type: FUNC
 * @tc.level: Level1
 * @tc.require:
 */
HWTEST_F(AuthManagerMockTest, IS_NEED_REOPEN_AUTH_CONNECTION_TEST_009, TestSize.Level1)
{
    AuthManagerInterfaceMock authManagerMock;
    EXPECT_CALL(authManagerMock, LnnConvertDlId)
        .WillRepeatedly(Return(SOFTBUS_OK));
...
/*
 * @tc.name: IS_NEED_REOPEN_AUTH_CONNECTION_TEST_010
 * @tc.desc: Server auth manager found, return false
 * @tc.type: FUNC
 * @tc.level: Level1
 * @tc.require:
 */
HWTEST_F(AuthManagerMockTest, IS_NEED_REOPEN_AUTH_CONNECTION_TEST_010, TestSize.Level1)
{
    AuthManagerInterfaceMock authManagerMock;
    EXPECT_CALL(authManagerMock, LnnConvertDlId)
        .WillRepeatedly(Return(SOFTBUS_OK));
