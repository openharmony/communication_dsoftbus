...
class LNNLaneLinkNewTest : public testing::Test {
public:
...
void LNNLaneLinkNewTest::SetUpTestCase()
{
    GTEST_LOG_(INFO) << "LNNLaneLinkNewTest start";
    (void)SoftBusMutexInit(&g_lock, nullptr);
    (void)SoftBusCondInit(&g_cond);
    LnnInitLnnLooper();
}

void LNNLaneLinkNewTest::TearDownTestCase()
{
    LnnDeinitLnnLooper();
    (void)SoftBusCondDestroy(&g_cond);
    (void)SoftBusMutexDestroy(&g_lock);
    GTEST_LOG_(INFO) << "LNNLaneLinkNewTest end";
}

void LNNLaneLinkNewTest::SetUp()
{
}

void LNNLaneLinkNewTest::TearDown()
{
}
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GET_WLAN_LINKED_FREQUENCY_TEST_002, TestSize.Level1)
{
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LnnConnectP2p_001, TestSize.Level1)
{
    LinkRequest request;
    LaneLinkCb cb;
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LnnConnectP2p_002, TestSize.Level1)
{
    LinkRequest request;
    LaneLinkCb cb;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LnnConnectP2p_003, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LnnConnectP2p_004, TestSize.Level1)
{
    LinkRequest request;
    LaneLinkCb cb;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfSync_001, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfSync_002, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfSync_003, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfSync_004, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfSync_005, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfSync_006, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfSync_007, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfSync_008, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfSync_009, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfAsync_001, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfAsync_002, TestSize.Level1)
{
    LinkRequest request = {};
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfAsync_003, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfAsync_004, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfAsync_005, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfAsync_006, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetryOfAsync_007, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetry_001, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetry_002, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetry_003, TestSize.Level1)
{
    LinkRequest request;
    (void)memset_s(&request, sizeof(LinkRequest), 0, sizeof(LinkRequest));
    int32_t ret = strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GuideChannelRetry_004, TestSize.Level1)
{
    LinkRequest request = {};
    EXPECT_EQ(strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID), EOK);
    request.linkType = LANE_P2P;
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LnnCancelWifiDirect_001, TestSize.Level1)
{
    LinkRequest request = {};
    EXPECT_EQ(strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID), EOK);
    request.linkType = LANE_P2P;
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LnnCancelWifiDirect_002, TestSize.Level1)
{
    LinkRequest request = {};
    EXPECT_EQ(strcpy_s(request.peerNetworkId, NETWORK_ID_BUF_LEN, NODE_NETWORK_ID), EOK);
    request.linkType = LANE_P2P;
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LnnCancelWifiDirect_003, TestSize.Level1)
{
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LnnCancelWifiDirect_004, TestSize.Level1)
{
    uint32_t laneReqId = LANEREQID;
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LnnCancelWifiDirect_005, TestSize.Level1)
{
    uint32_t laneReqId = LANEREQID;
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LnnCancelWifiDirect_006, TestSize.Level1)
{
    uint32_t laneReqId = LANEREQID;
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GET_MAC_INFO_BY_LANE_ID_TEST_001, TestSize.Level1)
{
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, GET_MAC_INFO_BY_LANE_ID_MOCK_TEST_002, TestSize.Level1)
{
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, CHECK_IS_AUTH_SESSION_SERVER_TEST_002, TestSize.Level1)
{
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LNN_LANE_LINK_P2P_TEST_001, TestSize.Level1)
{
    bool isServer;
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LNN_LANE_LINK_P2P_TEST_002, TestSize.Level1)
{
    bool isServer;
    uint32_t laneReqId = LANEREQID;
    SetCommonFunction(laneReqId, LANE_P2P, g_manager);
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LNN_LANE_LINK_P2P_TEST_003, TestSize.Level1)
{
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LNN_LANE_LINK_P2P_TEST_004, TestSize.Level1)
{
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LNN_LANE_LINK_P2P_TEST_005, TestSize.Level1)
{
    NiceMock<LaneDepsInterfaceMock> mock;
    LanePreferredLinkList recommendList = {};
    LanePreferredLinkList request = {};
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LNN_LANE_LINK_P2P_TEST_006, TestSize.Level1)
{
    LanePreferredLinkList recommendList = {};
    LanePreferredLinkList request = {};
    request.linkTypeNum = 1;
    ...
    NiceMock<LaneDepsInterfaceMock> linkMock;
    EXPECT_CALL(linkMock, LnnGetLocalNumU32Info).WillRepeatedly(Return(SOFTBUS_INVALID_PARAM));
    int32_t ret = SelectAuthLane(NODE_NETWORK_ID, &request, &recommendList);
    EXPECT_EQ(ret, SOFTBUS_LANE_NO_AVAILABLE_LINK);
}
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LNN_LANE_SELECT_01, TestSize.Level1)
{
    NiceMock<LaneDepsInterfaceMock> mock;
    LanePreferredLinkList recommendList = {};
...
* @tc.require:
*/
HWTEST_F(LNNLaneLinkNewTest, LNN_LANE_SELECT_02, TestSize.Level1)
{
    NiceMock<LaneDepsInterfaceMock> mock;
    LanePreferredLinkList recommendList = {};
    LaneSelectParam request = {};
