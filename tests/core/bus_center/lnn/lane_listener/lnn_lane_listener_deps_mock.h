...
public:
    ...
    virtual void ProcessPowerControlInfoByLaneReqId(const LaneLinkType, uint32_t laneReqId) = 0;
};
...
public:
    ...
    MOCK_METHOD2(ProcessPowerControlInfoByLaneReqId, void (const LaneLinkType, uint32_t laneReqId));
};
} // namespace OHOS
