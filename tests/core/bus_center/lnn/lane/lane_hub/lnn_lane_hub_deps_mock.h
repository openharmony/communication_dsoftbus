...
public:
    ...
    virtual int32_t PerceptionManagerInit(void) = 0;
    virtual void PerceptionManagerDeinit(void) = 0;
...
public:
    ...
    MOCK_METHOD0(PerceptionManagerInit, int32_t (void));
    MOCK_METHOD0(PerceptionManagerDeinit, void (void));
