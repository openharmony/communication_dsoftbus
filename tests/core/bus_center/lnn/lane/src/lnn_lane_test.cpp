...
constexpr uint32_t WIFI_DIRECT_EXT_CAP_VALID_TIME = 12000;
...
* @tc.require:
*/
HWTEST_F(LNNLaneMockTest, LNN_LANE_UPDATE_P2P_AVAILABILITY_001, TestSize.Level1)
{
...
* @tc.require:
*/
HWTEST_F(LNNLaneMockTest, LNN_LANE_UPDATE_P2P_AVAILABILITY_002, TestSize.Level1)
{
    EXPECT_EQ(SOFTBUS_INVALID_PARAM, UpdateP2pAvailability(nullptr, false));
    EXPECT_EQ(SOFTBUS_OK, UpdateP2pAvailability(PEER_UDID, false));
    EXPECT_EQ(SOFTBUS_OK, UpdateP2pAvailability(PEER_UDID, false));
...
* @tc.require:
*/
HWTEST_F(LNNLaneMockTest, LNN_LANE_ADJUST_LINK_PRIORITY_FOR_RTT_001, TestSize.Level1)
{
    NiceMock<LaneDepsInterfaceMock> laneMock;
    ...
    EXPECT_CALL(laneMock, LnnGetRemoteNumInfo).WillRepeatedly(
        DoAll(SetArgPointee<LANE_MOCK_PARAM3>(TYPE_CAR_ID), Return(SOFTBUS_OK)));
    ...
    GTEST_LOG_(INFO) << "wait wifidirect ext cap exceed timeliness with 12s";
...
* @tc.require:
*/
HWTEST_F(LNNLaneMockTest, LNN_LANE_ADJUST_LINK_PRIORITY_FOR_RTT_002, TestSize.Level1)
{
    NiceMock<LaneDepsInterfaceMock> laneMock;
    laneMock.SetDefaultResult(reinterpret_cast<NodeInfo *>(&g_NodeInfo));
    EXPECT_CALL(laneMock, LnnGetOnlineStateById).WillRepeatedly(Return(true));
