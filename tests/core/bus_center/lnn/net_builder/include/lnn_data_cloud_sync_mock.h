...
#ifndef LNN_DATA_CLOUD_SYNC_MOCK_H
#define LNN_DATA_CLOUD_SYNC_MOCK_H
...
public:
    ...
    MOCK_METHOD5(LnnPutDBData, int32_t(int32_t dbId, char *putKey, uint32_t putKeyLen, char *putValue,
