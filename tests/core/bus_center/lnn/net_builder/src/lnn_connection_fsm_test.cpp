...
HWTEST_F(LNNConnectionFsmTest, LNN_LEAVE_LNN_IN_ONLINE_TEST_001, TestSize.Level1)
{
    ...
    EXPECT_EQ(EOK, memcpy_s(targetObj.peerUid, MAX_ACCOUNT_HASH_LEN, PEERUID3, strlen(PEERUID3)));
    EXPECT_EQ(EOK, memcpy_s(targetObj.info.ip.ip, IP_STR_MAX_LEN, IP, strlen(IP)));
