...
public:
    ...
    virtual int32_t LnnPostSetMediumParamMsgToHbFsm(LnnHeartbeatFsm *hbFsm,
        const LnnHeartbeatMediumParam *para) = 0;
    virtual int32_t LnnPostCheckDevStatusMsgToHbFsm(LnnHeartbeatFsm *hbFsm,
        const LnnCheckDevStatusMsgPara *para, uint64_t delayMillis) = 0;
    virtual int32_t LnnPostScreenOffCheckDevMsgToHbFsm(LnnHeartbeatFsm *hbFsm,
        const LnnCheckDevStatusMsgPara *para, uint64_t delayMillis) = 0;
    ...
    virtual void LnnRemoveSendEndMsg(LnnHeartbeatFsm *hbFsm, LnnHeartbeatType type,
        bool wakeupFlag, bool isRelay, bool *isRemoved) = 0;
    virtual int32_t LnnPostNextSendOnceMsgToHbFsm(LnnHeartbeatFsm *hbFsm,
        const LnnProcessSendOnceMsgPara *para, uint64_t delayMillis) = 0;
    virtual void LnnRemoveProcessSendOnceMsg(LnnHeartbeatFsm *hbFsm,
        LnnHeartbeatType hbType, LnnHeartbeatStrategyType strategyType) = 0;
...
public:
    ...
    MOCK_METHOD3(LnnPostCheckDevStatusMsgToHbFsm, int32_t (LnnHeartbeatFsm *,
        const LnnCheckDevStatusMsgPara *, uint64_t));
    MOCK_METHOD3(LnnPostScreenOffCheckDevMsgToHbFsm, int32_t (LnnHeartbeatFsm *,
        const LnnCheckDevStatusMsgPara *, uint64_t));
    ...
    MOCK_METHOD3(LnnPostNextSendOnceMsgToHbFsm, int32_t (LnnHeartbeatFsm *,
        const LnnProcessSendOnceMsgPara *, uint64_t));
    MOCK_METHOD3(LnnRemoveProcessSendOnceMsg, void (LnnHeartbeatFsm *,
        LnnHeartbeatType, LnnHeartbeatStrategyType));
