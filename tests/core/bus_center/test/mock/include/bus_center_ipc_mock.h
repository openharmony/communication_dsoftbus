...
public:
    ...
    virtual int32_t LnnStartTimeSync(
        const char *pkgName, int32_t callingPid, const char *targetNetworkId, TimeSyncAccuracy accuracy, TimeSyncPeriod period) = 0;
    ...
    virtual int32_t ClientOnJoinLNNResult(const char *pkgName, int32_t pid, void *addr, uint32_t addrTypeLen,
        const char *networkId, int32_t retCode) = 0;
    virtual int32_t ClientOnJoinMetaNodeResult(const char *pkgName, int32_t pid, void *addr, uint32_t addrTypeLen,
        const char *networkId, int32_t retCode) = 0;
...
public:
    ...
    MOCK_METHOD4(LnnStartTimeSync, int32_t(const char *, int32_t, const char *, TimeSyncAccuracy, TimeSyncPeriod));
    ...
    MOCK_METHOD5(ClientOnJoinLNNResult, int32_t(const char *, int32_t, void *, uint32_t, const char *, int32_t));
    MOCK_METHOD5(ClientOnJoinMetaNodeResult, int32_t(const char *, int32_t, void *, uint32_t, const char *, int32_t));
    MOCK_METHOD3(ClientOnLeaveLNNResult, int32_t(const char *, int32_t, const char *, int32_t));
    MOCK_METHOD3(ClientOnLeaveMetaNodeResult, int32_t(const char *, int32_t, const char *, int32_t));
    ...
    MOCK_METHOD4(ClientOnTimeSyncResult, int32_t(const char *, int32_t, const void *, uint32_t, int32_t));
    MOCK_METHOD3(ClientOnPublishLNNResult, int32_t(const char *, int32_t, int32_t, int32_t));
    MOCK_METHOD3(ClientOnRefreshLNNResult, int32_t(const char *, int32_t, int32_t, int32_t));
    MOCK_METHOD3(ClientOnRefreshDeviceFound, int32_t(const char *, int32_t, const void *, uint32_t));
