...
public:
    ...
    static int32_t ActionofOnConnectSuccessed(const ConnectOption *option, uint32_t requestId,
        const ConnectResult *result);
    static int32_t ActionofOnConnectFailed(const ConnectOption *option, uint32_t requestId,
        const ConnectResult *result);
