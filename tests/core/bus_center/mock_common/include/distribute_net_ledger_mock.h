...
public:
    ...
    virtual int32_t LnnGetRemoteStrInfoByIfnameIdx(
        const char *netWorkId, InfoKey key, char *info, uint32_t len, int32_t ifIdx) = 0;
    virtual int32_t LnnGetRemoteNumInfoByIfnameIdx(
        const char *netWorkId, InfoKey key, int32_t *info, int32_t ifIdx) = 0;
