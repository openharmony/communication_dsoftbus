...
HWTEST_F(TransAuthMessageTest, TransAuthMessageTest001, TestSize.Level1)
{
    ...
    EXPECT_EQ(ret,  SOFTBUS_INVALID_PARAM);
    ret = TransAuthChannelMsgUnpack(NULL, appInfo);
    EXPECT_EQ(ret,  SOFTBUS_INVALID_PARAM);
    ret = TransAuthChannelMsgUnpack(TEST_AUTH_DATA, NULL);
    EXPECT_EQ(ret,  SOFTBUS_INVALID_PARAM);
    ret = TransAuthChannelMsgUnpack(TEST_AUTH_DATA, appInfo);
...
HWTEST_F(TransAuthMessageTest, TransAuthMessageUnpackTest001, TestSize.Level1)
{
    ...
    ret = TransAuthChannelMsgUnpack(data, appInfo);
    EXPECT_EQ(ret,  SOFTBUS_PARSE_JSON_ERR);
    cJSON_free(data);
