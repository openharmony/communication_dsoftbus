...
public:
    ...
    virtual int SoftBusStartAdv(int advId, const SoftBusBleAdvParams *param) = 0;
    virtual int SoftBusStopAdv(int advId) = 0;

    virtual int SoftBusUpdateAdv(int advId, const SoftBusBleAdvData *data, const SoftBusBleAdvParams *param) = 0;
    virtual int SoftBusSetAdvData(int advId, const SoftBusBleAdvData *data) = 0;
...
public:
    ...
    MOCK_METHOD(int, SoftBusReleaseAdvChannel, (int advId), (override));
    ...
    MOCK_METHOD(int, SoftBusStartAdv, (int advId, const SoftBusBleAdvParams *param), (override));
    MOCK_METHOD(int, SoftBusStopAdv, (int advId), (override));

    MOCK_METHOD(int, SoftBusSetAdvData, (int advId, const SoftBusBleAdvData *data), (override));
    MOCK_METHOD(int, SoftBusUpdateAdv, (int advId, const SoftBusBleAdvData *data, const SoftBusBleAdvParams *param),
                (override));
    ...
    static int32_t ActionOfReleaseAdvChannel(int advId);
    ...
    static int32_t ActionOfStartAdv(int advId, const SoftBusBleAdvParams *param);
    static int32_t ActionOfStopAdv(int advId);
    static int32_t ActionOfSetAdvDataForActiveDiscovery(int advId, const SoftBusBleAdvData *data);
    static int32_t ActionOfSetAdvDataForActivePublish(int advId, const SoftBusBleAdvData *data);
    static int32_t ActionOfUpdateAdvForPassivePublish(int advId, const SoftBusBleAdvData *data,
    ...
    static constexpr int ADV_CHANNEL_ID = 3;
