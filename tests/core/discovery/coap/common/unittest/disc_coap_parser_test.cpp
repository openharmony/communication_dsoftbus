...
/*
 * @tc.name: DiscCoapFillServiceData001
 * @tc.desc: ServiceData should fill fail when call DiscCoapFillServiceData with invalid capabilityData
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(DiscCoapParserTest, DiscCoapFillServiceData001, TestSize.Level1)
{
    ...
    ret = DiscCoapFillServiceData(capability, capabilityData.c_str(), dataLen, outData);
    EXPECT_EQ(ret, SOFTBUS_INVALID_PARAM);
...
/*
 * @tc.name: DiscCoapFillServiceData002
 * @tc.desc: ServiceData should fill success when call DiscCoapFillServiceData with valid capabilityData
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(DiscCoapParserTest, DiscCoapFillServiceData002, TestSize.Level1)
{
    ...
    ret = DiscCoapFillServiceData(capability, nullptr, dataLen, outData);
    EXPECT_EQ(ret, SOFTBUS_OK);
    EXPECT_STREQ(outData, "");
