...
MATCHER_P2(DiscValidParamArrayMatcher, inExtra, validSize, "disc valid param array match fail")
{
    ...
    EXPECT_STREQ(params[index].name, g_discAssigners[index].name);
    EXPECT_EQ(params[index].t, g_discAssigners[index].type);
    EXPECT_EQ(params[index].v.i32, extra.localNetworkId);
    ++index;
    EXPECT_STREQ(params[index].name, g_discAssigners[index].name);
    EXPECT_EQ(params[index].t, g_discAssigners[index].type);
    EXPECT_EQ(params[index].v.i32, extra.localDeviceType);
    ++index;
    EXPECT_STREQ(params[index].name, g_discAssigners[index].name);
    EXPECT_EQ(params[index].t, g_discAssigners[index].type);
    ...
    EXPECT_STREQ(params[index].name, g_discAssigners[index].name);
    EXPECT_EQ(params[index].t, g_discAssigners[index].type);
    EXPECT_EQ(params[index].v.i32, extra.peerNetworkId);
    ++index;
    EXPECT_STREQ(params[index].name, g_discAssigners[index].name);
    EXPECT_EQ(params[index].t, g_discAssigners[index].type);
    EXPECT_EQ(params[index].v.i32, extra.peerDeviceType);
    ++index;
    EXPECT_STREQ(params[index].name, g_discAssigners[index].name);
    EXPECT_EQ(params[index].t, g_discAssigners[index].type);
