...
{
    EXPECT_STREQ(CONN_EVENT_NAME, "CONN_EVENT");
    EXPECT_STREQ(DISC_EVENT_NAME, "DISC_EVENT");
    EXPECT_STREQ(LNN_EVENT_NAME, "LNN_EVENT");
    EXPECT_STREQ(TRANS_EVENT_NAME, "TRANS_EVENT");
}
