...
#ifndef NAPI_LINK_ENHANCE_SERVER_VIRTUAL_H
#define NAPI_LINK_ENHANCE_SERVER_VIRTUAL_H
...
public:
    ...
    explicit NapiLinkEnhanceServer(const std::string &name)
    {
        this->name_ = name;
    }
...
#endif /* NAPI_LINK_ENHANCE_SERVER_VIRTUAL_H */
