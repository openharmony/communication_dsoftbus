...
int32_t ClientTransTdcOnSessionOpened(const char *sessionName, const ChannelInfo *channel, SocketAccessInfo *accessInfo)
{
    ...
    return g_sessionCb.OnSessionOpened(sessionName, channel, type, accessInfo);
}
