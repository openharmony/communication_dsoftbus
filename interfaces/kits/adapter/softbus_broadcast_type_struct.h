...
#ifndef SOFTBUS_BROADCAST_TYPE_STRUCT_H
#define SOFTBUS_BROADCAST_TYPE_STRUCT_H
...
static const SrvTypeMap g_srvTypeMap[] = {
    {SRV_TYPE_HB, (char *)"HB"},
    {SRV_TYPE_CONN, (char *)"conn"},
    {SRV_TYPE_TRANS_MSG, (char *)"transMsg"},
    {SRV_TYPE_DIS, (char *)"distrib"},
    {SRV_TYPE_SHARE, (char *)"share"},
    {SRV_TYPE_APPROACH, (char *)"approach"},
    {SRV_TYPE_LP_BURST, (char *)"lpBurst"},
    {SRV_TYPE_LP_HB, (char *)"lpHB"},
    {SRV_TYPE_FAST_OFFLINE, (char *)"fastOfl"},
    {SRV_TYPE_VLINK, (char *)"virLink"},
    {SRV_TYPE_TOUCH, (char *)"touch"},
    {SRV_TYPE_OOP, (char *)"oop"},
    {SRV_TYPE_AUTH_CONN, (char *)"authConn"},
    {SRV_TYPE_OH_APPROACH, (char *)"ohAp"},
    {SRV_TYPE_D2D_PAGING, (char *)"d2dP"},
...
#endif /* SOFTBUS_BROADCAST_TYPE_STRUCT_H */
