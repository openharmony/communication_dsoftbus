...
enum DisSubModule {
    ...
    DISC_SD_SUB_MODULE_CODE = 9,
    DISC_SPARKLINK_SUB_MODULE_CODE = 10,
    DISC_D2D_SUB_MODULE_CODE = 11,
    DISC_VIRLINK_SUB_MODULE_CODE = 12,
    DISC_NFC_MODULE_CODE = 13,
};
...
enum SoftBusErrNo {
    ...
    SOFTBUS_CMP_FAIL, // strncmp failed
    ...
    SOFTBUS_DDOS_INIT_FAILED,
    SOFTBUS_DDOS_DISABLE,
    SOFTBUS_DDOS_ID_AND_USER_SAME_COUNT_LIMIT,
    SOFTBUS_DDOS_ID_SAME_COUNT_LIMIT,
    SOFTBUS_DDOS_USER_SAME_ID_COUNT_LIMIT,
    SOFTBUS_DDOS_USER_ID_ALL_COUNT_LIMIT,
    SOFTBUS_RC_ID_EXHAUSTED_ERR,
    SOFTBUS_FUNC_NOT_REGISTER,
    SOFTBUS_MLPS_GNSS_POWER_FAIL,
    SOFTBUS_SH_ABNORMAL_RESET,
    SOFTBUS_SH_ONLINE_REPEATLY,
    SOFTBUS_SOCKET_ERR,
    SOFTBUS_CALC_HKDF_FAIL,
    SOFTBUS_MLPS_GNSS_POWER_ON_TIMEOUT,
    SOFTBUS_SCREEN_DISABLE,
    SOFTBUS_AGENT_BUSY,
    SOFTBUS_ACCOUNT_CONSTRAINT_ENABLE,
    SOFTBUS_NETWORK_SUBSCRIBE_FAILED,
    SOFTBUS_CLOUD_SEND_FAIL,
    SOFTBUS_SOURCE_IS_NOT_PRIMARY_USER,
    SOFTBUS_SINK_IS_NOT_PRIMARY_USER,
    SOFTBUS_RESOLVE_ABILITY_ERR,
    ...
    SOFTBUS_TRANS_QOS_CHANNEL_OPEN_FAILED,
    ...
    SOFTBUS_TRANS_ON_CONNECT_REQUEST_INVALID,
    ...
    SOFTBUS_TRANS_SET_FIREWALL_FAIL,
    ...
    SOFTBUS_TRANS_BACKGROUND_USER_DENIED,
    SOFTBUS_TRANS_CROSS_LAYER_DENIED,
    SOFTBUS_TRANS_GEN_USER_KEY,
    SOFTBUS_TRANS_TOKEN_HAP_ERR,
    SOFTBUS_TRANS_BR_PROXY_DATA_TOO_LONG,
    SOFTBUS_TRANS_BR_PROXY_TOKENID_ERR,
    SOFTBUS_TRANS_BR_PROXY_CALLER_RESTRICTED,
    SOFTBUS_TRANS_BR_PROXY_INVALID_PARAM,
    SOFTBUS_TRANS_NUM_TO_SOCKET_NAME_FAIL,
    SOFTBUS_TRANS_PAGING_LIST_NOT_INIT,
    SOFTBUS_TRANS_PAGING_INFO_NOT_FOUND,
    SOFTBUS_TRANS_PAGING_SERVER_NOT_CREATED,
    SOFTBUS_TRANS_PAGING_ALREADY_LISTENED,
    SOFTBUS_TRANS_PAGING_SOCKET_IS_FORKED,
    SOFTBUS_TRANS_PAGING_ASYNC_FAIL,
    SOFTBUS_TRANS_PAGING_WAIT_LISTEN_NOT_FOUND,
    SOFTBUS_TRANS_PAGING_WAIT_LISTEN_TIMEOUT,
    SOFTBUS_TRANS_PAGING_WAIT_LISTEN_LOAD_FAIL,
    SOFTBUS_TRANS_PAGING_TIMEOUT,
    SOFTBUS_TRANS_PAGING_FILL_CHANNEL_FAIL,
    SOFTBUS_TRANS_PAGING_GET_PKGNAME_FAIL,
    SOFTBUS_TRANS_PAGING_SAVE_CHANNEL,
    SOFTBUS_TRANS_HEX_STR_TO_BYTES_FAIL,
    SOFTBUS_TRANS_BYTES_TO_HEX_STR_FAIL,
    SOFTBUS_TRANS_ALREADY_REGISTERED,
    SOFTBUS_TRANS_ALREADY_UNREGISTERED,
    SOFTBUS_TRANS_LISTEN_NOT_IMPLEMENT,
    SOFTBUS_TRANS_NODE_EXIST,
    SOFTBUS_TRANS_LEVEL_NOT_MATCH,
    SOFTBUS_TRANS_SCAN_MAC_NUMBER_FAILED,
    SOFTBUS_TRANS_PACK_REPLY_FAILED,
    ...
    SOFTBUS_TRANS_BR_PROXY_INTERNAL_ERROR,
    SOFTBUS_TRANS_BLOCK_MODE_REJECTED,
    SOFTBUS_TRANS_DLOPEN_FAILED,
    SOFTBUS_TRANS_DLSYM_FAILED,
    SOFTBUS_TRANS_DLCLOSE_FAILED,
    SOFTBUS_TRANS_META_PLUGIN_IS_ENABLE,
    ...
    SOFTBUS_AUTH_SESSION_KEY_CONN_TIMEOUT,
    SOFTBUS_AUTH_SLE_CONN_TIMEOUT,
    SOFTBUS_AUTH_USB_CONN_TIMEOUT,
    SOFTBUS_AUTH_ACL_NOT_FOUND,
    SOFTBUS_AUTH_CCMP_INIT_FAIL,
    SOFTBUS_AUTH_GET_CRED_INSTANCE_FAIL,
    SOFTBUS_AUTH_ACL_SET_CHANNEL_FAIL,
    SOFTBUS_AUTH_UK_NOT_FIND,
    SOFTBUS_AUTH_UK_TIMEOUT,
    SOFTBUS_AUTH_UK_INSTANCE_NOT_FIND,
    SOFTBUS_AUTH_UK_NEGOINFO_NOT_FIND,
    SOFTBUS_AUTH_NOT_FIND_LARGER_UDID,
    SOFTBUS_AUTH_GET_CRED_ID_FAIL,
    SOFTBUS_AUTH_UK_CACHE_INSTANCE_NOT_FIND,
    SOFTBUS_AUTH_UK_CACHE_INSTANCE_FULL,
    SOFTBUS_AUTH_REG_CRED_CHANGE_FAIL,
    SOFTBUS_AUTH_APPLY_KEY_INSTANCE_NOT_FOUND,
    SOFTBUS_AUTH_APPLY_KEY_NOT_FOUND,
    SOFTBUS_AUTH_GET_LIGHT_ACCOUNT_FAIL,
    SOFTBUS_AUTH_UK_UPDATE_ACL_FAIL,
    SOFTBUS_AUTH_INSERT_ACL_FAIL,
    SOFTBUS_AUTH_SAME_ID_ERR,
    ...
    SOFTBUS_NETWORK_CREATE_SYNC_INFO_PARAM_FAILED,
    ...
    SOFTBUS_NETWORK_DLSYM_FAILED,
    SOFTBUS_NETWORK_DLCLOSE_FAILED,
    ...
    SOFTBUS_NETWORK_REPEATED_DEVICEID,
    SOFTBUS_NETWORK_USB_REG_EVENT_FAILED,
    SOFTBUS_NETWORK_TIMER_SERVICE_ERR,
    SOFTBUS_LNN_PORT_GEN_ERR,
    SOFTBUS_NETWORK_GET_TIME_FAIL,
    SOFTBUS_TIME_SYNC_HQUEUE_EMPTY,
    SOFTBUS_NETWORK_TIME_SYNC_SVM_FAILED,
    SOFTBUS_NETWORK_TIME_SYNC_NTPH_PRCS_FAIL,

    SOFTBUS_NETWORK_LNN_OPEN_FUNC_INIT_FAILED,
    SOFTBUS_NETWORK_LNN_ENHANCE_FUNC_INIT_FAILED,
    SOFTBUS_NETWORK_CONN_OPEN_FUNC_INIT_FAILED,
    SOFTBUS_NETWORK_CONN_ENHANCE_FUNC_INIT_FAILED,
    SOFTBUS_NETWORK_ADAPTER_OPEN_FUNC_INIT_FAILED,
    SOFTBUS_NETWORK_ADAPTER_ENHANCE_FUNC_INIT_FAILED,
    SOFTBUS_NETWORK_CLIENT_OPEN_FUNC_INIT_FAILED,
    SOFTBUS_NETWORK_CLIENT_ENHANCE_FUNC_INIT_FAILED,
    SOFTBUS_NETWORK_AUTH_OPEN_FUNC_INIT_FAILED,
    SOFTBUS_NETWORK_AUTH_ENHANCE_FUNC_INIT_FAILED,
    SOFTBUS_NETWORK_DISC_OPEN_FUNC_INIT_FAILED,
    SOFTBUS_NETWORK_DISC_ENHANCE_FUNC_INIT_FAILED,
    SOFTBUS_NETWORK_TRANS_OPEN_FUNC_INIT_FAILED,
    SOFTBUS_NETWORK_TRANS_ENHANCE_FUNC_INIT_FAILED,

    SOFTBUS_SLE_RANGING_NOT_ENABLE,
    SOFTBUS_SLE_RANGING_REGIST_TRANS_ERROR,
    SOFTBUS_SLE_RANGING_ALREADY_RUNNING,
    SOFTBUS_SLE_RANGING_NOT_RUNNING,
    SOFTBUS_SLE_RANGING_ALREADY_STOP,
    SOFTBUS_SLE_RANGING_INNER_ERROR,
    SOFTBUS_SLE_RANGING_NET_LEDGER_ERROR,
    SOFTBUS_SLE_RANGING_NOT_SUPPORT_ERROR,
    SOFTBUS_SLE_RANGING_CONNECT_ERROR,
    SOFTBUS_SLE_RANGING_TRANS_ERROR,
    SOFTBUS_PERCEPTION_SCAN_NOT_START,
    SOFTBUS_NETWORK_USB_GETMAC_FAILED,
    SOFTBUS_NETWORK_USB_MODE_INVALID,
    SOFTBUS_NETWORK_CONFIG_NETLINK_IPV6_FAILED,
    SOFTBUS_NETWORK_USB_DISCONNECT,
    SOFTBUS_SLE_ASSEMBLE_INFO_FAIL,
    SOFTBUS_SLE_GET_TIMESTAMP_FAIL,
    SOFTBUS_NETWORK_CLOUD_NO_NEED_OFFLINE,
    SOFTBUS_NETWORK_SYNC_INFO_BY_CLOUD_FAIL,
    SOFTBUS_NETWORK_NOT_SUPPORT_VIRTUAL_LINK,
    SOFTBUS_NETWORK_DEVICE_TYPE_ERROR,
    SOFTBUS_NETWORK_WRITEINT64_FAILED,
    SOFTBUS_NETWORK_WRITEUINT32_FAILED,
    SOFTBUS_NETWORK_GET_DISPLAY_ID_FAIL,
    SOFTBUS_SLE_RANGING_CONFLICT_ERROR,
    SOFTBUS_NETWORK_USER_INFO_INIT_FAILED,
    SOFTBUS_NETWORK_GET_LOCAL_LEDGER_FAILED,
    SOFTBUS_NETWORK_UPDATE_MULTI_USER_FAILED,
    SOFTBUS_KV_DATA_LISTENER_ALREADY_REGISTER,
    SOFTBUS_NETWORK_FSM_NOT_EXIST_FAIL,
    SOFTBUS_NETWORK_HEARTBEAT_CHANNEL_DISABLE,
    ...
    SOFTBUS_LANE_LOCAL_NO_BLE_DIRECT_FEATURE,
    SOFTBUS_LANE_REMOTE_NO_BLE_DIRECT_FEATURE,
    ...
    SOFTBUS_LANE_LOCAL_NO_COC_FEATURE,
    SOFTBUS_LANE_REMOTE_NO_COC_FEATURE,
    ...
    SOFTBUS_LANE_TRANS_TYPE_NOT_MATCH,
    SOFTBUS_LANE_LOCAL_NO_WIFI_DIRECT_ENHANCE_FEATURE,
    SOFTBUS_LANE_REMOTE_NO_WIFI_DIRECT_ENHANCE_FEATURE,
    SOFTBUS_LANE_LOCAL_NO_P2P_REUSE_FEATURE,
    SOFTBUS_LANE_REMOTE_NO_P2P_REUSE_FEATURE,
    SOFTBUS_LANE_LOCAL_NO_BLE_STATIC_CAP,
    SOFTBUS_LANE_REMOTE_NO_BLE_STATIC_CAP,
    SOFTBUS_LANE_LOCAL_NO_BR_STATIC_CAP,
    SOFTBUS_LANE_REMOTE_NO_BR_STATIC_CAP,
    SOFTBUS_LANE_LOCAL_NO_WIFI_STATIC_CAP,
    SOFTBUS_LANE_REMOTE_NO_WIFI_STATIC_CAP,
    SOFTBUS_LANE_LOCAL_NO_P2P_STATIC_CAP,
    SOFTBUS_LANE_REMOTE_NO_P2P_STATIC_CAP,
    SOFTBUS_LANE_LOCAL_NO_ENHANCED_P2P_STATIC_CAP,
    SOFTBUS_LANE_REMOTE_NO_ENHANCED_P2P_STATIC_CAP,
    SOFTBUS_LANE_LOCAL_NO_ETH_STATIC_CAP,
    SOFTBUS_LANE_REMOTE_NO_ETH_STATIC_CAP,
    SOFTBUS_LANE_LOCAL_NO_ETH_CAP,
    SOFTBUS_LANE_REMOTE_NO_ETH_CAP,
    SOFTBUS_LANE_LOCAL_NO_USB_STATIC_CAP,
    SOFTBUS_LANE_REMOTE_NO_USB_STATIC_CAP,
    SOFTBUS_LANE_LOCAL_NO_USB_CAP,
    SOFTBUS_LANE_REMOTE_NO_USB_CAP,
    SOFTBUS_LANE_LOCAL_NO_SLE_CAP,
    SOFTBUS_LANE_REMOTE_NO_SLE_CAP,
    SOFTBUS_LANE_LOCAL_NO_SLE_STATIC_CAP,
    SOFTBUS_LANE_REMOTE_NO_SLE_STATIC_CAP,
    SOFTBUS_LANE_LOCAL_NO_SLE_FEATURE,
    SOFTBUS_LANE_REMOTE_NO_SLE_FEATURE,
    SOFTBUS_LANE_LOCAL_NO_FL_CAP,
    SOFTBUS_LANE_REMOTE_NO_FL_CAP,
    SOFTBUS_SPARK_SEND_MSG_FAILED,
    SOFTBUS_INTERACT_CONTROL_SIGNALING_FAIL,
    SOFTBUS_SPARK_INVITE_NODE_TIMEOUT,
    SOFTBUS_INTERACT_CONTROL_SIGNALING_QUEUE_LIMIT,
    SOFTBUS_LANE_ALLOC_NOT_COMPLETED,
    ...
    SOFTBUS_NETWORK_LP_MCU_RESTART,
    SOFTBUS_NETWORK_LP_DEVICE_OFFLINE,

    SOFTBUS_LNN_PTK_NOT_MATCH = SOFTBUS_ERRNO(SHORT_DISTANCE_MAPPING_MODULE_CODE) + 4,
    SOFTBUS_CONN_P2P_STA_SAME_MAC = SOFTBUS_ERRNO(SHORT_DISTANCE_MAPPING_MODULE_CODE) + 201,
    ...
    SOFTBUS_CONN_HV2_ACTION_TRIGGER_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 157,
    SOFTBUS_CONN_HV2_SPARKLINK_TRIGGER_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 158,
    SOFTBUS_CONN_BR_SOCKET_LIMITED_RESOURCES = SOFTBUS_CONN_ERR_BASE + 180,

    SOFTBUS_CONN_SLE_INTERNAL_ERROR = SOFTBUS_CONN_ERR_BASE + 300,
    SOFTBUS_CONN_SLE_NOT_SUPPORT = SOFTBUS_CONN_ERR_BASE + 301,
    SOFTBUS_CONN_ID_EXHAUSTED_ERR = SOFTBUS_CONN_ERR_BASE + 302,
    SOFTBUS_CONN_SLE_CONNECT_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 303,
    SOFTBUS_CONN_SLE_CANCEL_CONN_TIME_OUT = SOFTBUS_CONN_ERR_BASE + 304,
    SOFTBUS_CONN_SLE_NOT_SUPPORT_PORPERTY = SOFTBUS_CONN_ERR_BASE + 305,
    SOFTBUS_CONN_SLE_NOT_INVALID_PARAM = SOFTBUS_CONN_ERR_BASE + 306,
    SOFTBUS_CONN_SLE_CANCEL_CONNECTTION_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 307,
    SOFTBUS_CONN_SLE_START_SERVICE_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 308,
    SOFTBUS_CONN_SLE_CLIENT_CONNECTING_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 309,
    SOFTBUS_CONN_SLE_CLIENT_FINDING_STRUCTURE_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 310,
    SOFTBUS_CONN_SLE_CLIENT_SETTING_PROPERTY_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 311,
    SOFTBUS_CONN_SLE_CLIENT_WAITING_MTU_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 312,
    SOFTBUS_CONN_SLE_CLIENT_DISCONNECTING_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 313,
    SOFTBUS_CONN_SLE_CLIENT_CREATE_ERR = SOFTBUS_CONN_ERR_BASE + 314,
    SOFTBUS_CONN_SLE_OFF = SOFTBUS_CONN_ERR_BASE + 315,

    SOFTBUS_CONN_DIRECT_INTERNAL_ERR = SOFTBUS_CONN_ERR_BASE + 400,

    SOFTBUS_CONN_GENERAL_SERVER_NOT_OPENED = SOFTBUS_CONN_ERR_BASE + 401,
    SOFTBUS_CONN_GENERAL_MSG_NOT_FOUND = SOFTBUS_CONN_ERR_BASE + 402,
    SOFTBUS_CONN_GENERAL_CONNECTION_CLOSE = SOFTBUS_CONN_ERR_BASE + 403,
    SOFTBUS_CONN_GENERAL_PEER_CONNECTION_CLOSE = SOFTBUS_CONN_ERR_BASE + 404,
    SOFTBUS_CONN_GENERAL_UNDERLAY_DISCONNECT = SOFTBUS_CONN_ERR_BASE + 405,
    SOFTBUS_CONN_GENERAL_PACK_ERROR = SOFTBUS_CONN_ERR_BASE + 406,
    SOFTBUS_CONN_GENERAL_CONNECT_FAILED = SOFTBUS_CONN_ERR_BASE + 407,
    SOFTBUS_CONN_GENERAL_CONNECT_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 408,
    SOFTBUS_CONN_GENERAL_POST_MSG_FAILED = SOFTBUS_CONN_ERR_BASE + 409,
    SOFTBUS_CONN_GENERAL_DUPLICATE_SERVER = SOFTBUS_CONN_ERR_BASE + 410,
    SOFTBUS_CONN_GENERAL_CREATE_SERVER_MAX = SOFTBUS_CONN_ERR_BASE + 411,
    SOFTBUS_CONN_GENERAL_CREATE_CLIENT_MAX = SOFTBUS_CONN_ERR_BASE + 412,
    SOFTBUS_CONN_GENERAL_CONNECTION_NOT_READY = SOFTBUS_CONN_ERR_BASE + 413,
    SOFTBUS_CONN_GENERAL_LISTENER_NOT_ENABLE = SOFTBUS_CONN_ERR_BASE + 414,

    SOFTBUS_CONN_BR_DISABLE_ERR = SOFTBUS_CONN_ERR_BASE + 415,
    SOFTBUS_CONN_OPEN_PROXY_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 416,
    SOFTBUS_CONN_PROXY_CONCURRENT_OPERATION_ERR = SOFTBUS_CONN_ERR_BASE + 417,
    SOFTBUS_CONN_PROXY_NOT_SUPPORT_ERR = SOFTBUS_CONN_ERR_BASE + 418,
    SOFTBUS_CONN_PROXY_INTERNAL_ERR = SOFTBUS_CONN_ERR_BASE + 419,
    SOFTBUS_CONN_BR_UNPAIRED = SOFTBUS_CONN_ERR_BASE + 420,
    ...
    SOFTBUS_CONN_PROXY_REMOTE_DISCONNECT = SOFTBUS_CONN_ERR_BASE + 425,

    SOFTBUS_FAR_FIELD_NOT_PREPARED = SOFTBUS_CONN_ERR_BASE + 450,
    SOFTBUS_FAR_FIELD_INTERNAL_ERR = SOFTBUS_CONN_ERR_BASE + 451,
    SOFTBUS_FAR_FIELD_NOT_SUPPORT = SOFTBUS_CONN_ERR_BASE + 452,
    SOFTBUS_CONN_PROXY_BR_FAIL_BUT_SUPPORT_FAR_FIELD = SOFTBUS_CONN_ERR_BASE + 453,
    SOFTBUS_FAR_FIELD_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 454,
    SOFTBUS_FAR_FIELD_DISCONNECT = SOFTBUS_CONN_ERR_BASE + 455,
    SOFTBUS_FAR_FIELD_NOT_CONNECTED = SOFTBUS_CONN_ERR_BASE + 456,
    ...
    SOFTBUS_CONN_RETRYABLE_FAIL_WITH_CURRENT_GUIDE = SOFTBUS_CONN_ERR_BASE + 722,
    SOFTBUS_CONN_PV2_CONNECT_GROUP_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 723,
    SOFTBUS_CONN_HML_ENABLE_LOW_POWER_FAIL = SOFTBUS_CONN_ERR_BASE + 724,
    SOFTBUS_CONN_VIRTUAL_LINK_NOT_ALLOWED = SOFTBUS_CONN_ERR_BASE + 725,
    SOFTBUS_CONN_P2P_GO_NO_EXIST = SOFTBUS_CONN_ERR_BASE + 726,
    SOFTBUS_CONN_P2P_ROLE_IS_GC = SOFTBUS_CONN_ERR_BASE + 727,
    SOFTBUS_CONN_P2P_ROLE_INVALID = SOFTBUS_CONN_ERR_BASE + 728,
    SOFTBUS_CONN_ALREADY_CREATE_GROUP = SOFTBUS_CONN_ERR_BASE + 729,
    SOFTBUS_CONN_GO_IS_NOT_CREATED_SOFTBUS = SOFTBUS_CONN_ERR_BASE + 730,
    SOFTBUS_CONN_GET_RECOMMEND_FREQUENCY_FAILED = SOFTBUS_CONN_ERR_BASE + 731,
    SOFTBUS_CONN_FORCE_DISCONNECT_TIME_OUT = SOFTBUS_CONN_ERR_BASE + 732,
    SOFTBUS_CONN_RADAR_CHANNEL_CONFLICT = SOFTBUS_CONN_ERR_BASE + 733,
    SOFTBUS_CONN_PROHIBIT_CREATE_GROUP = SOFTBUS_CONN_ERR_BASE + 734,
    SOFTBUS_CONN_HML_P2P_DFS_CHANNEL_CONFLICT = SOFTBUS_CONN_ERR_BASE + 735,
    SOFTBUS_CONN_P2P_CALLBACK_PARAM_NULL = SOFTBUS_CONN_ERR_BASE + 736,
    ...
    SOFTBUS_CONN_ACTIVE_TYPE_STA_P2P_HML_CHIP_CONFLICT = SOFTBUS_CONN_ERR_BASE + 1033,
    SOFTBUS_CONN_PASSIVE_TYPE_STA_P2P_HML_CHIP_CONFLICT = SOFTBUS_CONN_ERR_BASE + 1034,
    ...
    SOFTBUS_CONN_LEGACY_RESOURCE_NOT_REG_LISTENER = SOFTBUS_CONN_ERR_BASE + 2021,
    SOFTBUS_CONN_LEGACY_BR_ALREADY_DISCONNECTED = SOFTBUS_CONN_ERR_BASE + 2022,
    ...
    SOFTBUS_CONN_SPARK_LINK_CREATE_GROUP_FAIL = SOFTBUS_CONN_ERR_BASE + 3000,
    SOFTBUS_CONN_SPARK_LINK_DESTROY_GROUP_FAIL = SOFTBUS_CONN_ERR_BASE + 3001,
    SOFTBUS_CONN_SPARK_LINK_INVITE_MEMBER_FAIL = SOFTBUS_CONN_ERR_BASE + 3002,
    SOFTBUS_CONN_SPARK_LINK_REMOVE_MEMBER_FAIL = SOFTBUS_CONN_ERR_BASE + 3003,
    SOFTBUS_CONN_SPARK_LINK_JOIN_GROUP_FAIL = SOFTBUS_CONN_ERR_BASE + 3004,
    SOFTBUS_CONN_SPARK_LINK_QUIT_GROUP_FAIL = SOFTBUS_CONN_ERR_BASE + 3005,
    SOFTBUS_CONN_SPARK_LINK_SEND_DATA_FAIL = SOFTBUS_CONN_ERR_BASE + 3006,
    SOFTBUS_CONN_SPARK_LINK_SET_SNIFF_MODE_FAIL = SOFTBUS_CONN_ERR_BASE + 3007,
    ...
    SOFTBUS_CONN_EVENT_INIT_FAIL = SOFTBUS_CONN_KERNELS_BASE + 114,
    SOFTBUS_CONN_EPOLL_ABNORMAL_EVENT = SOFTBUS_CONN_KERNELS_BASE + 115,
    ...
    SOFTBUS_DISCOVER_SCAN_NOT_SUPPORT,
    ...
    SOFTBUS_DISCOVER_MANAGER_CALLTIMES_MAX_ERR,
    SOFTBUS_DISCOVER_MANAGER_SCREEN_OFF_REJECTED,
    ...
    SOFTBUS_DISCOVER_BLE_NEED_TRIGGER,
    SOFTBUS_DISCOVER_BLE_SET_SCAN_PARAM_FAIL,
    SOFTBUS_DISCOVER_BLE_GET_ADV_POW_FAIL,
    ...
    SOFTBUS_DISCOVER_COAP_ASSEMBLE_BDATA_FAIL,
    ...
    SOFTBUS_BC_ADAPTER_DISABLED_FAIL,
    SOFTBUS_BC_ADAPTER_ENABLED_FAIL,
    ...
    SOFTBUS_AUTH_SUB_DP_FAILED,
    SOFTBUS_KV_SUBSCRIBE_SA_FAILED,

    /* errno begin: -((203 << 21) | (1 << 16) | (9 << 12) | 0x0FFF) */
    SOFTBUS_DISCOVER_SD_ERR_BASE = SOFTBUS_SUB_ERRNO(DISC_SUB_MODULE_CODE, DISC_SD_SUB_MODULE_CODE),
    SOFTBUS_DISCOVER_SD_INIT_FAIL,
    SOFTBUS_DISCOVER_SD_INFO_TOO_MUCH,
    SOFTBUS_DISCOVER_SD_DISCOVERY_BUSY,
    SOFTBUS_DISCOVER_SD_SERVICE_ID_EXIST,

    /* errno begin: -((203 << 21) | (1 << 16) | (10 << 12) | 0x0FFF) */
    SOFTBUS_DISCOVER_SPARKLINK_ERR_BASE = SOFTBUS_SUB_ERRNO(DISC_SUB_MODULE_CODE, DISC_SPARKLINK_SUB_MODULE_CODE),
    SOFTBUS_DISCOVER_SPARKLINK_INVALID_PACKET,
    SOFTBUS_DISCOVER_SPARKLINK_NOT_REGISTER,
    SOFTBUS_DISCOVER_SPARKLINK_ONLY_SEND,
    SOFTBUS_DISCOVER_SPARKLINK_ENCRYPT_ERROR,
    SOFTBUS_DISCOVER_SPARKLINK_DECRYPT_ERROR,
    SOFTBUS_DISCOVER_SPARKLINK_START_FAILED,
    SOFTBUS_DISCOVER_SPARKLINK_STOP_FAILED,

    /* errno begin: -((203 << 21) | (1 << 16) | (11 << 12) | 0x0FFF) */
    SOFTBUS_DISCOVER_D2D_ERR_BASE = SOFTBUS_SUB_ERRNO(DISC_SUB_MODULE_CODE, DISC_D2D_SUB_MODULE_CODE),
    SOFTBUS_DISCOVER_D2D_TIMEOUT,
    SOFTBUS_DISCOVER_D2D_CANCEL,
    SOFTBUS_DISCOVER_D2D_UPDATE,
    SOFTBUS_DISCOVER_D2D_NOT_REGISTER,
    SOFTBUS_DISCOVER_D2D_UNKNOWN_BUSINESS,
    SOFTBUS_DISCOVER_D2D_RESOURCE_UNAVAILABLE,

    /* errno begin: -((203 << 21) | (1 << 16) | (12 << 12) | 0x0FFF) */
    SOFTBUS_DISCOVER_VIRLINK_ERR_BASE = SOFTBUS_SUB_ERRNO(DISC_SUB_MODULE_CODE, DISC_VIRLINK_SUB_MODULE_CODE),
    SOFTBUS_DISCOVER_VIRLINK_ONLY_SEND,
    SOFTBUS_DISCOVER_VIRLINK_INVALID_PACKET,
    SOFTBUS_DISCOVER_VIRLINK_NOT_REGISTER,
    SOFTBUS_DISCOVER_VIRLINK_ENCRYPT_ERROR,
    SOFTBUS_DISCOVER_VIRLINK_DECRYPT_ERROR,
    SOFTBUS_DISCOVER_VIRLINK_START_FAILED,
    SOFTBUS_DISCOVER_VIRLINK_STOP_FAILED,
    SOFTBUS_DISCOVER_VIRLINK_PACKET_NOT_FIND,
    SOFTBUS_DISCOVER_VIRLINK_PACKET_NO_SPACE,

    SOFTBUS_DISCOVER_BR_DISABLE,

    /* errno begin: -((203 << 21) | (1 << 16) | (13 << 12) | 0x0FFF) */
    SOFTBUS_DISCOVER_NFC_ERR_BASE = SOFTBUS_SUB_ERRNO(DISC_SUB_MODULE_CODE, DISC_NFC_MODULE_CODE),
    SOFTBUS_DISCOVER_NFC_DISPATCHER_FAIL,
