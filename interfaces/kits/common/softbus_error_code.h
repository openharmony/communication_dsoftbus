...
enum SoftBusErrNo {
    ...
    SOFTBUS_HIDUMPER_PARAMS_INIT_FAIL,
    ...
    SOFTBUS_TRANS_NO_NEED_CACHE_ON_EVENT,
    ...
    SOFTBUS_CONN_DIRECR_INTERNAL_ERR = SOFTBUS_CONN_ERR_BASE + 400,
    ...
    SOFTBUS_CONN_SPARK_LINK_SETT_SNIFF_MODE_FAIL = SOFTBUS_CONN_ERR_BASE + 3007,
    ...
    SOFTBUS_DISCOVER_INVALID_CSTRING,
    ...
    SOFTBUS_DISCOVER_SD_SERVICE_ID_EXISTED,
    SOFTBUS_DISCOVER_SD_SPACE_NOT_MATCH,
    SOFTBUS_DISCOVER_SD_SERVICE_ID_NOT_EXISTED,
    SOFTBUS_DISCOVER_SD_ADD_SERVICE_FAILED,
