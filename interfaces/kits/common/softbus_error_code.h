...
enum SoftBusErrNo {
    ...
    SOFTBUS_FAR_FIELD_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 453,
    SOFTBUS_FAR_FIELD_DISCONNECT = SOFTBUS_CONN_ERR_BASE + 454,
    SOFTBUS_FAR_FIELD_NOT_CONNECTED = SOFTBUS_CONN_ERR_BASE + 455,
    SOFTBUS_FAR_FIELD_OPEN_FAIL = SOFTBUS_CONN_ERR_BASE + 456,
