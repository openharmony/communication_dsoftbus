...
enum SoftBusErrNo {
    ...
    SOFTBUS_AUTH_CONN_END_ERR,
    SOFTBUS_AUTH_START_ERR,
    SOFTBUS_AUTH_END_ERR,
    SOFTBUS_AUTH_EXCHANGE_CIPHER_START_ERR,
    SOFTBUS_AUTH_EXCHANGE_CIPHER_END_ERR,
    SOFTBUS_AUTH_EXCHANGE_DEVICE_INFO_START_ERR,
    SOFTBUS_AUTH_EXCHANGE_DEVICE_INFO_END_ERR,
