...
enum SoftBusErrNo {
	...
	SOFTBUS_CONN_INTERNAL_ERR,
    SOFTBUS_CONN_LISTENER_NOT_IDLE,
    SOFTBUS_CONN_GET_TIME_FAIL,
    SOFTBUS_CONN_GET_MSG_FAIL,
    SOFTBUS_COMM_BLE_ENABLE_ERR,
    SOFTBUS_COMM_BLE_DISABLE_ERR,
    SOFTBUS_COMM_BLUETOOTH_ADD_STATE_LISTENER_ERR,
    SOFTBUS_COMM_BLUETOOTH_UNDERLAY_GET_ADDR_ERR,
    SOFTBUS_COMM_BLUETOOTH_UNDERLAY_SET_NAME_ERR,
    SOFTBUS_COMM_BLUETOOTH_UNDERLAY_REGISTER_CB_ERR,
    SOFTBUS_COMM_BLUETOOTH_SWITCH_STATE_ERR,
    SOFTBUS_COMM_BLUETOOTH_ACL_SWITCH_STATE_ERR,
    SOFTBUS_CONN_BR_SOCKET_CONNECT_ERR,
    SOFTBUS_CONN_BR_SPP_SERVER_ERR,
    SOFTBUS_CONN_BR_CREATE_QUEUE_FAIL,
    SOFTBUS_CONN_BR_SET_PENDING_PACKET_ERR,
    SOFTBUS_CONN_BLE_UNDERLAY_CLIENT_SET_FASTEST_ERR,
    SOFTBUS_CONN_BLE_UNDERLAY_CLIENT_SET_PRIORITY_ERR,
    SOFTBUS_CONN_BLE_UNDERLAY_SERVER_CONNECT_ERR,
    SOFTBUS_CONN_BLE_UNDERLAY_SERVER_DISCONNECT_ERR,
    SOFTBUS_CONN_BLE_UNDERLAY_SERVER_SEND_RESPONSE_ERR,
    SOFTBUS_CONN_BLE_UNDERLAY_SERVER_SEND_INDICATION_ERR,
    SOFTBUS_CONN_BLE_CHECK_STATUS_ERR,
    SOFTBUS_CONN_SOCKET_INTERNAL_ERR,
    SOFTBUS_CONN_SOCKET_GET_INTERFACE_ERR,
    SOFTBUS_CONN_SOCKET_FCNTL_ERR,
    SOFTBUS_CONN_BYTES_TO_HEX_STR_ERR,
    SOFTBUS_CONN_HEX_STR_TO_BYTES_ERR,
    
    SOFTBUS_CONN_COAP_INTERNAL_ERR,
    SOFTBUS_CONN_COAP_DMSG_CONNET_ERR,
    SOFTBUS_CONN_COAP_DMSG_CLOSE_ERR,
    SOFTBUS_CONN_COAP_DMSG_SEND_ERR,
    SOFTBUS_CONN_COAP_DMSG_REGISTE_LOG_ERR,

    SOFTBUS_CONN_LEGACY_INTERNAL_ERR,
    SOFTBUS_CONN_LEGACY_GET_CHANNEL_FAIL,
    SOFTBUS_CONN_LEGACY_BLE_GET_CONNECTION_FAIL,
    SOFTBUS_CONN_LEGACY_BR_GET_CONNECTION_FAIL,
    SOFTBUS_CONN_LEGACY_HML_DEVICEID_ERR,
    SOFTBUS_CONN_LEGACY_HML_CONNECT_FAIL,
    SOFTBUS_CONN_LEGACY_HML_INTERNAL_ERR,
    SOFTBUS_CONN_LEGACY_P2P_INTERNAL_ERR,
    SOFTBUS_CONN_LEGACY_CREAT_LISTENER_MODULE_ERR,
    SOFTBUS_CONN_LEGACY_TCP_INTERNAL_ERR,
    SOFTBUS_CONN_LEGACY_TCP_SEND_SIZE_ERR,
    SOFTBUS_CONN_LEGACY_ADD_TRIGGER_FAIL,
    SOFTBUS_CONN_LEGACY_HANDLE_OPEN_REQ_FAIL,
    SOFTBUS_CONN_LEGACY_POST_TIME_OUT_FAIL,
    SOFTBUS_CONN_LEGACY_POST_MSG_TO_LOOPER_FAIL,
    SOFTBUS_CONN_LEGACY_GET_CHANNEL_MANAGER_FAIL,
    SOFTBUS_CONN_LEGACY_SEND_MESSAGE_FAIL,
    SOFTBUS_CONN_LEGACY_SEND_MESSAGE_DELAYED_FAIL,
    SOFTBUS_CONN_LEGACY_GET_P2P_ABILITY_FAIL,
