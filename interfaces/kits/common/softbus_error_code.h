...
enum SoftBusErrNo {
    ...
    SOFTBUS_CONN_BLE_GENERAL_SERVER_NOT_OPENED = SOFTBUS_CONN_ERR_BASE + 300,
    SOFTBUS_CONN_BLE_GENERAL_MSG_NOT_FOUND = SOFTBUS_CONN_ERR_BASE + 301,
    SOFTBUS_CONN_BLE_GENERAL_CONNECTION_CLOSE = SOFTBUS_CONN_ERR_BASE + 302,
    SOFTBUS_CONN_BLE_GENERAL_PEER_CONNECTION_CLOSE = SOFTBUS_CONN_ERR_BASE + 303,
    SOFTBUS_CONN_BLE_GENERAL_UNDERLAY_DISCONNECT = SOFTBUS_CONN_ERR_BASE + 304,
    SOFTBUS_CONN_BLE_GENERAL_PACK_ERROR = SOFTBUS_CONN_ERR_BASE + 305,
    SOFTBUS_CONN_BLE_GENERAL_CONNECT_FAILED= SOFTBUS_CONN_ERR_BASE + 306,
    SOFTBUS_CONN_BLE_GENERAL_CONNECT_TIMEOUT = SOFTBUS_CONN_ERR_BASE + 307,
    SOFTBUS_CONN_BLE_GENERAL_POST_MSG_FAILED = SOFTBUS_CONN_ERR_BASE + 308,
    SOFTBUS_CONN_BLE_GENERAL_DUPLICATE_SERVER = SOFTBUS_CONN_ERR_BASE + 309,
    SOFTBUS_CONN_BLE_GENERAL_CREATE_SERVER_MAX = SOFTBUS_CONN_ERR_BASE + 310,
    SOFTBUS_CONN_BLE_GENERAL_CREATE_CLIENT_MAX = SOFTBUS_CONN_ERR_BASE + 311,
    SOFTBUS_CONN_BLE_GENERAL_CONNECTION_NOT_READY = SOFTBUS_CONN_ERR_BASE + 312,
