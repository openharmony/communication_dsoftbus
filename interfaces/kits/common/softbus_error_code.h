...
enum SoftBusErrNo {
    ...
    SOFTBUS_CONN_CONN_NOTIFY_FAIL = SOFTBUS_CONN_ERR_BASE + 710,
    ...
    SOFTBUS_CONN_NET_REACH = KERNELS_SUB_MODULE_CODE + 101,
    SOFTBUS_CONN_SOCKET_TIME_OUT = KERNELS_SUB_MODULE_CODE + 110,
    SOFTBUS_CONN_SOCKET_REFUSED = KERNELS_SUB_MODULE_CODE + 111,
