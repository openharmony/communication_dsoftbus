...
enum SoftBusErrNo {
    ...
    SOFTBUS_NETWORK_GET_CLIENT_PROXY_ERR,
    SOFTBUS_NETWORK_PROXY_REMOTE_NULL,
    SOFTBUS_NETWORK_PROXY_WRITETOKEN_FAILED,
    SOFTBUS_NETWORK_PROXY_WRITECSTRING_FAILED,
    SOFTBUS_NETWORK_PROXY_WRITEINT_FAILED,
    SOFTBUS_NETWORK_PROXY_WRITEUINT_FAILED,
    SOFTBUS_NETWORK_PROXY_WRITERAWDATA_FAILED,
    SOFTBUS_NETWORK_PROXY_SEND_REQUEST_FAILED,
    SOFTBUS_NETWORK_READINT_FAILED,
    SOFTBUS_NETWORK_READUINT_FAILED,
    SOFTBUS_NETWORK_READRAWDATA_FAILED,
    SOFTBUS_NETWORK_WRITEINT_FAILED,
