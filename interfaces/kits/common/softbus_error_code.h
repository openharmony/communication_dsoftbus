...
enum SoftBusErrNo {
    ...
    SOFTBUS_TRANS_ON_CONNECT_REQUEST_INVAILD,
    SOFTBUS_TRANS_ON_SOCKET_OPENED_INVAILD,
    SOFTBUS_TRANS_ON_SOCKET_REQUEST_INVAILD,
    SOFTBUS_TRANS_ON_SOCKET_CLOSED_INVAILD,
    SOFTBUS_TRANS_ON_DATA_RECEIVED_INVAILD,
    SOFTBUS_TRANS_ON_PREDATA_REQUEST_INVAILD,
    SOFTBUS_TRANS_ON_SERVICE_REQUEST_INVAILD,
    SOFTBUS_TRANS_ON_SESSION_REQUEST_IS_NULL,
    SOFTBUS_TRANS_ON_SESSION_OPENED_INVAILD,
    SOFTBUS_TRANS_ON_SESSION_CLOSED_INVAILD,
    SOFTBUS_TRANS_CREATE_LISTENER_MODULE_FAILED,
    SOFTBUS_TRANS_FILE_SCHEMA_LISTENER_FAILED,
    SOFTBUS_TRANS_DEATH_RECIPIENT_INVAILD,
