...
enum SoftBusErrNo {
    ...
    /* errno begin: -((203 << 21) | (2 << 16) | 0xFFFF) + 10000 */
    SOFTBUS_CONN_ERR_BASE = (SOFTBUS_ERRNO(CONN_SUB_MODULE_CODE) + 10000),
    SOFTBUS_CONN_FAIL,
    ...
    SOFTBUS_CONN_BR_UNDERLAY_BASE_ERR = SOFTBUS_CONN_ERR_BASE + 150,
