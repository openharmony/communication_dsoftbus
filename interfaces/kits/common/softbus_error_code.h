...
enum SoftBusSubModule {
    ...
    SHORT_DISTANCE_CHIP_ACTIVE_MODULE_CODE = 21,
    SHORT_DISTANCE_CHIP_PASSIVE_MODULE_CODE = 22,
};
...
enum SoftBusErrNo {
    ...
    /* short range chip conflict active error */
    SOFTBUS_SHORT_RANGE_ERR_ACTIVE_BASE = SOFTBUS_ERRNO(SHORT_DISTANCE_CHIP_ACTIVE_MODULE_CODE),
    ...
    /* short range chip conflict passive error */
    SOFTBUS_SHORT_RANGE_ERR_PASSIVE_BASE = SOFTBUS_ERRNO(SHORT_DISTANCE_CHIP_PASSIVE_MODULE_CODE),
