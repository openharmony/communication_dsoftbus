...
int32_t ClientOnJoinLNNResult(const char *pkgName, int32_t pid, void *addr, uint32_t addrTypeLen,
    const char *networkId, int32_t retCode);
int32_t ClientOnJoinMetaNodeResult(const char *pkgName, int32_t pid, void *addr, uint32_t addrTypeLen,
    const char *networkId, int32_t retCode);
