...
#define HB_SHORT_ACCOUNT_ID_HASH_LEN 2
#define HB_SHA_HASH_LEN 32
#define HB_FSM_NAME_LEN 32

#define HB_TIME_FACTOR (1000LL)
#define HB_SEND_ONCE_LEN (10 * HB_TIME_FACTOR)
#define HB_CHECK_DELAY_LEN (10 * HB_TIME_FACTOR)
#define HB_CHECK_OFFLINE_TOLERANCE_LEN (2 * HB_TIME_FACTOR + HB_CHECK_DELAY_LEN)
