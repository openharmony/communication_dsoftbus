...
void DiscClientProxy::OnDeviceFound(const DeviceInfo *deviceInfo)
{
    ...
    DISC_CHECK_AND_RETURN_LOGE(remote->SendRequest(CLIENT_DISCOVERY_DEVICE_FOUND, data, reply, option) == ERR_OK,
...
void DiscClientProxy::OnDiscoverFailed(int subscribeId, int reason)
{
    ...
    MessageParcel reply;
    MessageOption option { MessageOption::TF_ASYNC };
    DISC_CHECK_AND_RETURN_LOGE(remote->SendRequest(CLIENT_DISCOVERY_FAIL, data, reply, option) == ERR_OK,
        DISC_CONTROL, "send request failed");
}
...
void DiscClientProxy::OnDiscoverySuccess(int subscribeId)
{
    ...
    MessageParcel reply;
    MessageOption option { MessageOption::TF_ASYNC };
    DISC_CHECK_AND_RETURN_LOGE(remote->SendRequest(CLIENT_DISCOVERY_SUCC, data, reply, option) == ERR_OK,
        DISC_CONTROL, "send request failed");
}
...
void DiscClientProxy::OnPublishSuccess(int publishId)
{
    ...
    MessageParcel reply;
    MessageOption option { MessageOption::TF_ASYNC };
    DISC_CHECK_AND_RETURN_LOGE(remote->SendRequest(CLIENT_PUBLISH_SUCC, data, reply, option) == ERR_OK,
        DISC_CONTROL, "send request failed");
}
...
void DiscClientProxy::OnPublishFail(int publishId, int reason)
{
    ...
    MessageParcel reply;
    MessageOption option{MessageOption::TF_ASYNC};
    DISC_CHECK_AND_RETURN_LOGE(remote->SendRequest(CLIENT_PUBLISH_FAIL, data, reply, option) == ERR_OK,
        DISC_CONTROL, "send request failed");
}
}