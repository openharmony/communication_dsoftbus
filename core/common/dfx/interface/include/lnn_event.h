...
#define LNN_ALARM(scene, extra) ConnAlarmInner(scene, __FUNCTION__, __LINE__, extra)
#define LNN_STATS(scene, extra) ConnStatsInner(scene, __FUNCTION__, __LINE__, extra)
#define LNN_AUDIT(scene, extra) ConnStatsInner(scene, __FUNCTION__, __LINE__, extra)
...
void LnnAuditInner(int32_t scene, const char *func, int32_t line, LnnStatsExtra extra);
