...
#define CONN_AUDIT(scene, extra) ConnStatsInner(scene, __FUNCTION__, __LINE__, extra)
...
void ConnAuditInner(int32_t scene, const char *func, int32_t line, ConnStatsExtra extra);
