...
enum SoftBusFuncId {
    ...
    SERVER_PROCESS_PUSH_MSG,
    SERVER_RIPPLE_STATS,
    SERVER_GET_BUS_CENTER_EX_OBJ,
    SERVER_GET_DATASYNC_EX_OBJ,
    SERVER_GET_DM_EX_OBJ,
    SERVER_EVALUATE_QOS,
    ...
    SERVER_CREATE_GROUP_OWNER,
    SERVER_DESTROY_GROUP_OWNER,
    ...
    SERVER_SET_NODE_KEY_INFO,
    SERVER_START_ACCOUNT_AUTH,
    SERVER_PROCESS_ACCOUNT_AUTH,
    SERVER_GET_TRUSTED_DEVICES,
    SERVER_POST_CONVERSATION_DATA,
    SERVER_REGISTER_CONVERSATION_LISTENER,
    SERVER_UNREGISTER_CONVERSATION_LISTENER,

    SERVER_SET_COMMAND,
    SERVER_REGISTER_COMMAND_CB,

    SERVER_START_PERCEPTION_ADV,
    SERVER_STOP_PERCEPTION_ADV,
    SERVER_START_PERCEPTION_SCAN,
    SERVER_STOP_PERCEPTION_SCAN,
    SERVER_GET_PERCEPTION_DEVICE_LIST,
    SERVER_SET_PERCEPTION_ADV_HIGH_FREQ,
    ...
    CLIENT_ON_TRANSMIT_AUTH_RESULT,
    CLIENT_ON_SESSIONKEY_AUTH_RESULT,
    CLIENT_ON_FINISH_AUTH_RESULT,
    CLIENT_ON_ERROR_AUTH_RESULT,
    CLIENT_GENERAL_SERVER_STOPPED,
    CLIENT_ON_COMMAND,
    CLIENT_ON_CONVERSATION_RECV_MSG,
    CLIENT_ON_PROFILE_DELETED,
