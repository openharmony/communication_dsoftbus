    ...
    int32_t module, int64_t seq, PostBytesFinishAction postBytesFinishAction)
{
    ...
    if (g_startBleSendLPInfo.isStartSendLp) {
        ...
        g_startBleSendLPInfo.isStartSendLp = false;
