...
const ServerInvokeCmd g_serverInvokeCmdTbl[] = {
    ...
    { SERVER_TRIGGER_HB_FOR_RANGE, ServerTriggerHbForMeasureDistance },
    { SERVER_REG_BLE_RANGE_CB, ServerRegBleRangeCb },
    { SERVER_UNREG_BLE_RANGE_CB, ServerUnregBleRangeCb },
