...
typedef enum {
    EVENT_STAGE_SPARK_GROUP_BUILD_RESULT = 1,
    EVENT_STAGE_SPARK_LINK_SEND_DATA,
    EVENT_STAGE_SPARK_LINK_SEND_RESULT,
    EVENT_STAGE_SPARK_LINK_MAX_NODE_NUM,
    EVENT_STAGE_SPARK_LINK_RECV_DATA,
    EVENT_STAGE_SPARK_BUILD_GROUP,
    EVENT_STAGE_SPARK_JOIN_GROUP,
    EVENT_STAGE_SPARK_NODE_ONLINE,
    EVENT_STAGE_SPARK_NODE_OFFLINE,
    EVENT_STAGE_SPARK_NODE_CLEAR,
