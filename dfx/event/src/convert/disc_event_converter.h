...
DISC_ASSIGNER(Uint64, StartTime, startTime)
DISC_ASSIGNER(Uint64, CostTime, costTime)
...
static HiSysEventParamAssigner g_discAssigners[] = {
    ...
    { "START_TIME",           HISYSEVENT_UINT64,  DiscAssignerStartTime      },
    { "COST_TIME",            HISYSEVENT_UINT64,  DiscAssignerCostTime       },
